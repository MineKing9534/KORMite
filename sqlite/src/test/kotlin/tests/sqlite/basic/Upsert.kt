...
class UpsertTest {
	...
	val entries = listOf(
		UpsertTestObject(id2 = 1, name = "Tom", email = "tom@example.com"),
		UpsertTestObject(id2 = 2, name = "Alex", email = "alex@example.com"),
		UpsertTestObject(id2 = 3, name = "Bob", email = "bob@example.com"),
		UpsertTestObject(id2 = 4, name = "Eve", email = "eve@example.com"),
		UpsertTestObject(id2 = 5, name = "Max", email = "max@example.com")
	)
