...
inline fun <reified T> createDummy() = Proxy.newProxyInstance(DatabaseConnection::class.java.classLoader, arrayOf(T::class.java)) { _, m, _ ->
	when (m.name) {
		"toString" -> "Dummy ${T::class.simpleName}"
		"hashCode" -> 0
		"equals" -> false
        else -> Unit
	}
